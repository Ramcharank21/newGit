...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths=" + "/bin/SaveServlet",
           })
public class SaveServlet extends SlingAllMethodsServlet {
...
protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response)
	...
	// TODO Auto-generated method stub
	   ...
	   log.info("Name "+name+"password "+password+"email "+email+" country "+country);

	   myemp.employRegi(name, password, email, country);
	   
	   log.info("doPost method called-----SaveServlet");

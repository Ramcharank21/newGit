...
$(document).ready(function(){
	...
	$('#id').on("input keyup", function() {
		...
		$.get("ExistIdServlet", {
			id : id			//sending FrontEnd data from here to above servlet
		},
		function(result) {
			//alert("result ---" + result);
			$("#idError").text(result);
...
<%-- <jsp:forward page="/ExistId.jsp"></jsp:forward>jsp:forward > --%>
...
<form action="SignupServlet" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" placeholder="Enter Mobile Number" name="mbl" id="mbl"  required>
